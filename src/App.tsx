...
function App() {
  ...
  return (
    <>
      ...
      <button type="button" onClick={handleToggle}>Toggle Example</button>
      {!toggle && <Example />}
      <Tool />
      <RandomDog/>
      <SpaceMissionForm />
